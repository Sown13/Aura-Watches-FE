        ...
        <div class="comment d-flex flex-column">
            ...
            <div className="comment-list">
                <div className="d-flex" style={{  borderRadius: "8px", marginTop: "1%" }}>
                    <div className="d-flex justify-content-center align-items-center" style={{ border: "2px solid #e8c284", borderRadius: "50%", width: "50px", height: "50px" , margin: "1%"}}>
                        T
                    </div>
                ...
                <div className="d-flex" style={{  borderRadius: "8px", marginTop: "1%" }}>
                    ...
                    <div  className="d-flex flex-column justify-content-center">
                        ...
                        <div>Perfect gift for my husband</div>
                    </div>
                </div>
                ...
                <div className="d-flex" style={{  borderRadius: "8px", marginTop: "1%" }}>
                    ...
                    <div  className="d-flex flex-column justify-content-center">
                        ...
                        <div>Their warranty is amazing</div>
                    </div>
                </div>
            </div>
        </div >
